...
//  Animations
//
//  Created by Daniel Kuroski on 20.11.20.
//
...
struct StepperButtonAnimation: View {
    @State private var animationAmount: CGFloat = 1
...
struct ControllingAnimationButton: View {
...
struct GradientDragAnimation: View {
...
struct ConditionalRenderingAnimation: View {
